...
This example comes with a complete REST API to handle Authentication and CRUD features on Users and their corresponding UserProfile. You may view the API documentation on the [Wiki](https://github.com/polcham/mongoose-express-ts/wiki).
